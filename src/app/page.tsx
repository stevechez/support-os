...
export const metadata: Metadata = {
  title: "SupportOS — The operating system for AI-powered customer support",
  description:
    "Connect your channels, upload your knowledge, and let AI resolve routine tickets while your team supervises. Inbox, copilot, automations, and RAG knowledge base in one calm workspace.",
  openGraph: {
    title: "SupportOS",
    description:
      "Humans supervise. AI resolves. The operating system for AI-powered customer support.",
    type: "website",
  },
};
...
const features = [
  {
    ...
    title: "AI Copilot",
    description:
      "Summaries, suggested replies, sentiment and intent analysis, tone rewriting, and translation — one click each, right inside the conversation.",
  },
  {
    icon: BookOpen,
    title: "Knowledge that answers",
    description:
      "Upload PDFs, docs, or URLs. SupportOS indexes everything with semantic search and grounds every AI reply in your actual policies — with citations.",
  },
  {
    icon: Workflow,
    title: "Automations",
    description:
      "A visual builder for workflows like “refund request → classify → draft reply → notify a human.” AI steps included. No code.",
  },
  {
    icon: MessagesSquare,
    title: "Every channel, one inbox",
    description:
      "An embeddable chat widget, inbound email, and Slack alerts flow into one Apple Mail–calm, three-column inbox.",
  },
  {
    icon: Bot,
    title: "Your models, your choice",
    description:
      "Switch between Claude, GPT, and Gemini per workspace. Bring your own API keys — no lock-in, no markup on tokens.",
  },
  {
    icon: ShieldCheck,
    title: "Built for teams",
    description:
      "Roles and invitations, org-level isolation with row-level security, usage limits, and a full audit log from day one.",
  },
];
...
const steps = [
  {
    ...
    description:
      "Drop the chat widget on your site, point your inbound email at SupportOS, and wire Slack for alerts. Minutes, not weeks.",
  },
  {
    number: "02",
    title: "Teach it your business",
    description:
      "Upload help docs, policies, and FAQs. The knowledge base indexes them instantly for semantic search and cited answers.",
  },
  {
    number: "03",
    title: "Let AI take the routine",
    description:
      "Automations classify, draft, and resolve repetitive tickets. Your team supervises and handles what actually needs a human.",
  },
];
...
const faqs = [
  {
    ...
    a: "Anthropic Claude, OpenAI GPT, and Google Gemini — switchable per workspace. You bring your own API keys, so you pay providers directly with no markup.",
  },
  {
    q: "How does the AI know my policies?",
    a: "Upload PDFs, Word docs, Markdown, or URLs to the knowledge base. Content is chunked, embedded, and retrieved semantically — replies cite the exact documents they came from.",
  },
  {
    q: "Can AI reply without a human?",
    a: "Only when you say so. Automations can draft replies for human review, or auto-resolve specific ticket types you choose — like password resets. You set the boundaries.",
  },
  {
    q: "Is my data isolated?",
    a: "Every workspace is isolated with Postgres row-level security. Public channels authenticate with revocable per-workspace tokens, and every sensitive action lands in the audit log.",
  },
];
        ...
        <section className="relative">
          ...
          <div className="relative mx-auto max-w-4xl px-6 pb-20 pt-24 text-center sm:pt-32">
            ...
            >
              ...
              AI-native customer support, live in minutes
            </Badge>
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              SupportOS is the operating system for AI-powered customer
              support — one calm inbox where AI drafts, classifies, and
              resolves routine tickets, grounded in your own documentation.
            </p>
            ...
            <p className="mt-4 text-xs text-muted-foreground">
              Free plan included · No credit card · Bring your own AI keys
            </p>
          </div>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex-1 space-y-3 p-4">
                    ...
                    <div className="ml-auto max-w-[80%] rounded-xl rounded-tr-sm bg-primary px-3 py-2 leading-relaxed text-primary-foreground">
                      ...
                      that. I&apos;ve refunded invoice #8852; you&apos;ll see
                      it within 3–5 business days.
                    </div>
                ...
                <div className="hidden border-l sm:block">
                  ...
                  <div className="space-y-1 p-2">
                    ...
                    <div className="mt-2 rounded-md border bg-background/50 p-2.5 leading-relaxed">
                      ...
                      Refund issued per policy §2.1 — duplicate charges
                      reversed within 5 days. [1]
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-24">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                No implementation project. No sales call. Connect, upload,
                and let it run.
              </p>
            </div>
        ...
        <section id="pricing" className="border-t bg-card/30">
          <div className="mx-auto max-w-4xl px-6 py-24">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Start free. Upgrade when the AI is earning its keep.
              </p>
            </div>
            ...
            <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div className="relative rounded-2xl border border-primary/30 bg-card p-8 shadow-lg shadow-primary/5">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  For teams running support on autopilot.
                </p>
        ...
        <section className="relative border-t">
          ...
          <div className="relative mx-auto max-w-3xl px-6 py-28 text-center">
            ...
            <p className="mx-auto mt-4 max-w-md text-muted-foreground">
              Create a workspace, load the demo data, and watch the Copilot
              work a real conversation — in under two minutes.
            </p>
